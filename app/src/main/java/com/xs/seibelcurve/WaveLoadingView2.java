...
public class WaveLoadingView2 extends View {
    ...
    // 左右偏移 φ
    private int fai = 0,fai2 = 50;
    // 上下偏移
    private float k = -50,k2 = -50;
    // 角速度
    private float w = 0.5f,w2 = 0.5f;
    // 振幅
    private int a = 20,a2 = 50;
     ...
     * @param a
      波浪振幅， 默认为 20
     */
    public WaveLoadingView2 setAmplitude(int a) {
        this.a = a;
        this.a2 = a;
        return this;
    }
     ...
     *            默认为0.5
     */
    public WaveLoadingView2 setPalstance(float w) {
        this.w = w;
        this.w2 = w;
        return this;
    }
     ...
     *            默认为4毫秒
     */
    public WaveLoadingView2 setRefreshTime(int ms) {
        this.ms = ms;
        return this;
    }
